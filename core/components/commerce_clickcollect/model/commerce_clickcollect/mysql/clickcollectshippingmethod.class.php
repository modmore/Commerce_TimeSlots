<?php
require_once strtr(realpath(dirname(dirname(__FILE__))), '\\', '/') . '/clickcollectshippingmethod.class.php';
/**
 ...
 */
class ClickCollectShippingMethod_mysql extends ClickCollectShippingMethod
{
