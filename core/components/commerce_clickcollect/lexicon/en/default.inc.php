...
$_lang['commerce_clickcollect.price'] = 'Price';
$_lang['commerce_clickcollect.price.desc'] = 'The price for this specific slot. This will be added to (or if you provide a negative amount, removed from) the base price configured on the shipping method. ';
